...
export type CanselRepeatingPlanningMutation = {
  ...
  canselRepeatingPlanning: {
    ...
    transactions?: Array<{
      ...
      amount: number
      currency: string
      exchangeRate: { __typename?: 'ExchangeRate'; rates: any }
    }> | null
  }
}
...
export type CreateTransactionMutation = {
  ...
  createTransaction: {
    ...
    exchangeRate: { __typename?: 'ExchangeRate'; id: string; base: string; date: any; rates: any }
  }
}
...
export type DeletePlanningMutation = {
  __typename?: 'Mutation'
  deletePlanning: { __typename?: 'Planning'; id: string; monthIndex: number; year: number }
}
...
export type PlanningExchangeRateQuery = {
  __typename?: 'Query'
  exchangeRate: { __typename?: 'ExchangeRate'; id: string; base: string; date: any; rates: any }
}
...
export type RepeatPlanningMutation = {
  __typename?: 'Mutation'
  repeatPlanning: {
    __typename?: 'Planning'
    id: string
...
export type RepeatingPlanningQuery = {
  __typename?: 'Query'
  repeatingPlanning: Array<{
    __typename?: 'Planning'
    id: string
    amount: number
    currency: string
...
export type SettingsStatisticsMutation = {
  __typename?: 'Mutation'
  updateProfile: {
    __typename?: 'UserWithoutPasswordModel'
    id: string
...
export type TransactionStatisticQuery = {
  __typename?: 'Query'
