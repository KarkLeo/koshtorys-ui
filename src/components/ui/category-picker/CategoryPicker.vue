...
const props = withDefaults(defineProps<{ error?: boolean; categories?: string[] }>(), {})
const items = computed(() => props.categories ?? TRANSACTION_CATEGORIES)
const { t } = useI18n()
  ...
  <Combobox v-model="model">
    ...
    <ComboboxList class="w-[var(--reka-popper-anchor-width)] p-0">
      ...
      <div class="max-h-[300px] overflow-y-auto p-1">
        <ComboboxItem v-for="id in items" :key="id" :value="id">
